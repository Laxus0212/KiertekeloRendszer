    ...
    <body>
        ...
        <form action="regisztracio.php" method="post" width="100%;">
            <fieldset style="-webkit-border-radius: 8px;
                ...
                <p>Már tag vagy? <a href="../belepes/belepes.php" id="href" onmouseover="this.style.color = 'blue';" onmouseout="this.style.color = 'lightskyblue';">->Belépés<-</a></p>
            </fieldset>
        </form>
    </body>
</html>