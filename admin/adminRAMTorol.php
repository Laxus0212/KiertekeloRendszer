...
<h2>RAM törlés</h2>
<p>A listából kiválasztott RAM, majd 'Töröl' gomb megnyomásával kitörölheti az adatbázisból az adott RAM adatot!'</p>

<form action="../admin/adminRAMTorol.php" method="post" style="height: auto;">
    <fieldset>
...
if (isset($_POST["torol"])) {
    ...
    $kapcsolat->torol($_POST["lista"], "ram");
    $kapcsolat->kapcsolatZar();
    header("Location: ../admin/adminRAMTorol.php");
}
?>
