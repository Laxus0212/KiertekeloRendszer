...
<p>A listából kiválasztott felhasználó, majd 'Töröl' gomb megnyomásával kitörölheti az adatbázisból a felhasználót!'</p>

<form action="../admin/adminFelhTorol.php" method="post" style="height: auto;">
    <fieldset>
        <div class="form-group">
            <select class="form-control" size="20" id="lista" name="lista" size="5">';
                <?php
                include_once "../nevekLista/adatLista.php";
                new adatLista("szadatok", "admin < 2");
                ?>
            </select>
        </div>
...
if (isset($_POST["torol"])) {
    ...
    $kapcsolat->torol($_POST["lista"], "szadatok");
    $kapcsolat->kapcsolatZar();
    header("Location: ../admin/adminFelhTorol.php");
}
?>
