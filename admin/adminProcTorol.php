...
<h2>CPU törlés</h2>
<p>A listából kiválasztott CPU, majd 'Töröl' gomb megnyomásával kitörölheti az adatbázisból az adott CPU adatot!'</p>

<form action="../admin/adminProcTorol.php" method="post" style="height: auto;">
    <fieldset>
...
if (isset($_POST["torol"])) {
    ...
    $kapcsolat->torol($_POST["lista"], "cpu");
